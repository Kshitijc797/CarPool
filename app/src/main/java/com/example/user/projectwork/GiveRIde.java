...
public class GiveRIde extends AppCompatActivity {
   // DB_RECORD db;
    EditText ed1,pickup,drop,carid;
     ...
     //   db= new DB_RECORD(this);
        ...
        ed1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                new DatePickerDialog(GiveRIde.this,date,ca.get(Calendar.YEAR),ca.get(Calendar.MONTH),ca.get(Calendar.DAY_OF_MONTH)).show();   //if we want to use date picker dialog in android project we hav to call 5 parameters type constructor of date picker dialog class
