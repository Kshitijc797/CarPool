                ...
                firebaseAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(Register.this, "Registered Succesfully Welcome "+name + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                ...
                                if (!task.isSuccessful()) {
                                  ...
                                  //  Toast.makeText(getApplicationContext(),"Registered Succesfully Welcome "+name,Toast.LENGTH_LONG).show();
