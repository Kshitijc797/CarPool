...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    // LogCat tag
    private static final String TAG = CurrentLoc.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharelocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showToast("IT WILL SHARE LOCATION");
            }
        });
        ...
        locationgmaps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showToast("IT WILL show map LOCATION");
            }
        });
